...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/julieth221/API_CRUD_SPIKE/API_CRUD_USUARIO/controllers:TipoDocumentoController"] = append(beego.GlobalControllerRouter["github.com/julieth221/API_CRUD_SPIKE/API_CRUD_USUARIO/controllers:TipoDocumentoController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
