...
// FincaController operations for Finca
type FincaController struct {
	beego.Controller
}

// URLMapping ...
func (c *FincaController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Finca
// @Param	body		body 	models.Finca	true		"body for Finca content"
// @Success 201 {int} models.Finca
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *FincaController) Post() {
	var v models.Finca
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddFinca(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Finca by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Finca
// @Failure 404 not found resource
// @router /:id [get]
func (c *FincaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetFincaById(id)
	if err != nil {
...
func (c *FincaController) GetAll() {
	...
	l, err := models.GetAllFinca(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Finca
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Finca	true		"body for Finca content"
// @Success 200 {object} models.Finca
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *FincaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Finca{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateFincaById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Finca
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 404 not found resource
// @router /:id [delete]
func (c *FincaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteFinca(id); err == nil {
