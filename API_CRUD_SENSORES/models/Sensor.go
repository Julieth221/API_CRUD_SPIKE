...
// AddSensor insert a new Sensor into database and returns
...
// GetSensorById retrieves Sensor by Id. Returns error if
// Id doesn't exist
func GetSensorById(id int) (v *Sensor, err error) {
	o := orm.NewOrm()
	v = &Sensor{Id: id}
...
// GetAllSensor retrieves all Sensor matches certain condition. Returns empty list if
// no records exist
...
// UpdateSensor updates Sensor by Id and returns error if
...
// DeleteSensor deletes Sensor by Id and returns error if
// the record to be deleted doesn't exist
func DeleteSensor(id int) (err error) {
	o := orm.NewOrm()
	v := Sensor{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&Sensor{Id: id}); err == nil {
