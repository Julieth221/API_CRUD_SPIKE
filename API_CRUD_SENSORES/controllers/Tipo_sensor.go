...
// TipoSensorController operations for TipoSensor
type TipoSensorController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoSensorController) URLMapping() {
...
func (c *TipoSensorController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoSensor(&v); err == nil {
...
func (c *TipoSensorController) GetOne() {
	...
	v, err := models.GetTipoSensorById(id)
	if err != nil {
...
func (c *TipoSensorController) GetAll() {
	...
	l, err := models.GetAllTipoSensor(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the TipoSensor
...
func (c *TipoSensorController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoSensor{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoSensorById(&v); err == nil {
...
func (c *TipoSensorController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoSensor(id); err == nil {
