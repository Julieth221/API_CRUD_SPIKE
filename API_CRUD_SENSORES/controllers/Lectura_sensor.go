...
// LecturaSensorController operations for LecturaSensor
type LecturaSensorController struct {
	beego.Controller
}

// URLMapping ...
func (c *LecturaSensorController) URLMapping() {
...
func (c *LecturaSensorController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddLecturaSensor(&v); err == nil {
...
func (c *LecturaSensorController) GetOne() {
	...
	v, err := models.GetLecturaSensorById(id)
	if err != nil {
...
func (c *LecturaSensorController) GetAll() {
	...
	l, err := models.GetAllLecturaSensor(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the LecturaSensor
...
func (c *LecturaSensorController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.LecturaSensor{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateLecturaSensorById(&v); err == nil {
...
func (c *LecturaSensorController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteLecturaSensor(id); err == nil {
